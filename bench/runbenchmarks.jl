...
suite["GEOSFP"]["stream"]["Interpolation serial"] = @benchmarkable interpfunc_serial($itp_stream, $EarthSciData.interp!)
suite["GEOSFP"]["stream"]["Interpolation threaded"] = @benchmarkable interpfunc_threads($itp_stream, $EarthSciData.interp!)
suite["GEOSFP"]["nostream"]["Interpolation serial"] = @benchmarkable interpfunc_serial($itp_nostream, $EarthSciData.interp_unsafe)
suite["GEOSFP"]["nostream"]["Interpolation threaded"] = @benchmarkable interpfunc_threads($itp_nostream, $EarthSciData.interp_unsafe)
...
suite["NEI Simulator"]["Serial"] = @benchmarkable solve($prob_serial, Euler(), dt=100.0,
...
suite["NEI Simulator"]["Threads"] = @benchmarkable solve($prob_serial, Euler(), dt=100.0,
    save_on=false, save_start=false, save_end=false, initialize_save=false)
