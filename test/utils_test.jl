@testitem "to_unit new entries" tags=[:utils] begin
    using EarthSciData
...
@testitem "to_unit CF convention ** normalization" tags=[:utils] begin
    using EarthSciData
    using DynamicQuantities
...
@testitem "to_unit existing entries" tags=[:utils] begin
    using EarthSciData
    using DynamicQuantities
