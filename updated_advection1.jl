...
# Use the decompressesed .nc file 
...
eq = [
    Dt(so2(x,y,t)) ~ -u(x,y)*Dx(so2(x,y,t)) - v(x,y)*Dy(so2(x,y,t)) + emission(x, y) - k*so2(x,y,t),
...
#pdesys = PDESystem(eq,bcs,domains,[x,y,t],[so2(x,y,t), so4(x,y,t)])
